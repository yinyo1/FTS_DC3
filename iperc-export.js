  ...
  try{
    ...
    function FillMerge(r1,c1,r2,c2,fillHex){
      for(var ri=r1;ri<=r2;ri++) for(var ci=c1;ci<=c2;ci++){
        ...
        if(!ws[addr]) ws[addr]={v:'',t:'s',s:{fill:{patternType:'solid',fgColor:{rgb:fillHex}},border:{top:{style:'thin'},bottom:{style:'thin'},left:{style:'thin'},right:{style:'thin'}}}};
      }
    }
  ...
  try{
    ...
    doc.autoTable({
      ...
      columnStyles:{
        ...
        1:{cellWidth:48},                    // Actividades
        2:{cellWidth:5,  halign:'center'},   // #
        3:{cellWidth:12, halign:'center'},   // Tipo peligro
        4:{cellWidth:26},                    // Desc riesgo
        5:{cellWidth:20},                    // Quién
        ...
        11:{cellWidth:12},                   // Eliminación
        12:{cellWidth:12},                   // Sustitución
        13:{cellWidth:22},                   // Ingeniería
        14:{cellWidth:30},                   // Admin
        15:{cellWidth:22},                   // EPP

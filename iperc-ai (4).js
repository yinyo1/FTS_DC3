// ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
// FTS-FILE-ID: iperc-ai-R5-20260313
// Verificar: window.FTS_AI_BUILD en consola del browser
// ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
window.FTS_AI_BUILD = 'iperc-ai-R5-20260313';
...
'{"actividades":[{"paso":"1","nombre":"NOMBRE FASE EN MAYÚSCULAS","descripcion":"Descripción ejecutiva de la fase","consideraciones":"Vamos a verificar [checklist supervisor ANTES de iniciar]","nota":"CONDICIÓN CRÍTICA EN MAYÚSCULAS si aplica (zona tráfico, planta activa, LOTO, etc.)","subpasos":[{"paso":"1.1","descripcion":"Vamos a [acción] usando [herramienta/equipo + especificaciones]. [Quién] va a [qué hace exactamente]. [Coordinación/condición especial].","personal":"Rol del trabajador (ej: electricista certificado NOM-029, operador montacargas)"}]}]}';
